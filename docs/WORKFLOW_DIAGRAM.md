<!-- framework-tag: v2.49.1 framework-file: docs/WORKFLOW_DIAGRAM.md -->
...
│  │  • Escolher modo: light (~31 arquivos) ou full (~86)          │
│  │  • Se full: detectar monorepo (## Monorepo no CLAUDE.md L0)   │
│  ▼                                                               │
